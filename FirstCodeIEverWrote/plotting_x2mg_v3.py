...
def findReg(regimeNum,name,array,oneDay=0):
...
def meanOfLog(dataLim,xdata,ydata,speed=np.arange(200,1825,25)):
    ...
    for i in range(1,len(speed)):
        yvals = ydata[np.where((xdata >= speed[i-1]) & (xdata <= speed[i]) & (xdata != np.inf))]
        xvals = xdata[np.where((xdata >= speed[i-1]) & (xdata <= speed[i]) & (ydata != np.inf))]
...
def goodBins(lst1,lst2):
    ...
    arr1 = lst1[np.where((lst1 > 0.0) & (lst2 > 0.0) & (lst1 != np.inf) & (lst2 != np.inf))]
    arr2 = lst2[np.where((lst1 > 0.0) & (lst2 > 0.0) & (lst1 != np.inf) & (lst2 != np.inf))]
...
mg2olow2,mg2oupp2,mg2omed2,mgspeed2=histWRanges(2,'mg2o',dataLim)
...
o76low2, o76upp2, o76med2,o76speed2=histWRanges(2,'o76',dataLim)
...
mg2olow1,mg2oupp1,mg2omed1,mgspeed1=histWRanges(1,'mg2o',dataLim)
...
o76low1, o76upp1, o76med1,o76speed1=histWRanges(1,'o76',dataLim)
...
mg2olow3,mg2oupp3,mg2omed3,mgspeed3=histWRanges(3,'mg2o',dataLim)
...
o76low3,o76upp3,o76med3,o76speed3=histWRanges(3,'o76',dataLim)
...
mg2olow0,mg2oupp0,mg2omed0,mgspeed0=histWRanges(0,'mg2o',dataLim)
...
o76low0,o76upp0,o76med0,o76speed0=histWRanges(0,'o76',dataLim)
...
for nm in range(len( names)):
    ...
    for rel in reglbls:
        ...
        x,y = findReg(rel,names[nm],abundn[names[nm]])
        x,y = goodBins(x,y)
