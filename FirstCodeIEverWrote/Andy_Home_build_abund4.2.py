...
gim_mom = np.load('/home/andy/Desktop/pythonstuff/gim_mom_sav.npy')
aswix = np.load('/home/andy/Desktop/pythonstuff/aswics_sav.npy')
swepam = np.load('/home/andy/Desktop/pythonstuff/swepam_sav.npy')
...
c_h = np.loadtxt('/home/andy/Desktop/pythonstuff/GNS_CH.txt',skiprows=2)
cme = np.loadtxt('/home/andy/Desktop/pythonstuff/GNS_CME.txt',skiprows=2)
i_s = np.loadtxt('/home/andy/Desktop/pythonstuff/GNS_IS.txt',skiprows=2)
...
#Save that shit! :
np.save('/home/andy/Desktop/pythonstuff/abund_struct',abundn)
np.save('/home/andy/Desktop/pythonstuff/regime_struct',regime)
