...
#fl_v = np.load('/home/andy/Desktop/pythonstuff/mgfl_v.npy')
#f_vdist = np.load('/home/andy/Desktop/pythonstuff/mgf_vdist.npy')
...
for i in range(4):
    ...
    snax.set_xlabel(r'Species Speed (km${ s^{ -1}}$)',fontsize = 'large')
...
def findReg(regimeNum,array,oneDay=0):
...
def goodBins(lst1,lst2):
    ...
    arr1 = lst1[np.where((lst1 > 0.0) & (lst2 > 0.0) & (np.inf not in lst1) & (np.inf not in lst2))]
    arr2 = lst2[np.where((lst1 > 0.0) & (lst2 > 0.0) & (np.inf not in lst1) & (np.inf not in lst2))]
...
def histWRanges(flagnum,fluence,dataLim,speed=np.arange(200,1825,25)):
    ...
    for i in range(1,len(speed)):
        ind = np.where((regime['v_p'] >= speed[i-1]-12.5) & (regime['v_p'] <= speed[i]-12.5) & (regime['v_p'] > 0.0) & (regime['flag'] == flagnum))
...
he2olow2, he2oupp2, he2omed2,hespeed2 = histWRanges(2,'he2o',dataLim)
c2olow2,c2oupp2,c2omed2,cspeed2=histWRanges(2,'c2o',dataLim)
n2olow2,n2oupp2,n2omed2,nspeed2=histWRanges(2,'n2o',dataLim)
ne2olow2,ne2oupp2,ne2omed2,nespeed2=histWRanges(2,'ne2o',dataLim)
mg2olow2,mg2oupp2,mg2omed2,mgspeed2=histWRanges(2,'o7',dataLim)
si2olow2,si2oupp2,si2omed2,sispeed2=histWRanges(2,'si2o',dataLim)
s2olow2,s2oupp2,s2omed2,sspeed2=histWRanges(2,'s2o',dataLim)
fe2olow2,fe2oupp2,fe2omed2,fespeed2=histWRanges(2,'fe2o',dataLim)
o76low2, o76upp2, o76med2,o76speed2=histWRanges(2,'o7',dataLim)

he2olow1, he2oupp1, he2omed1,hespeed1 = histWRanges(1,'he2o',dataLim)
c2olow1,c2oupp1,c2omed1,cspeed1=histWRanges(1,'c2o',dataLim)
n2olow1,n2oupp1,n2omed1,nspeed1=histWRanges(1,'n2o',dataLim)
ne2olow1,ne2oupp1,ne2omed1,nespeed1=histWRanges(1,'ne2o',dataLim)
mg2olow1,mg2oupp1,mg2omed1,mgspeed1=histWRanges(1,'o7',dataLim)
si2olow1,si2oupp1,si2omed1,sispeed1=histWRanges(1,'si2o',dataLim)
s2olow1,s2oupp1,s2omed1,sspeed1=histWRanges(1,'s2o',dataLim)
fe2olow1,fe2oupp1,fe2omed1,fespeed1=histWRanges(1,'fe2o',dataLim)
o76low1, o76upp1, o76med1,o76speed1=histWRanges(1,'o7',dataLim)

he2olow3, he2oupp3, he2omed3,hespeed3 = histWRanges(3,'he2o',dataLim)
c2olow3,c2oupp3,c2omed3,cspeed3=histWRanges(3,'c2o',dataLim)
n2olow3,n2oupp3,n2omed3,nspeed3=histWRanges(3,'n2o',dataLim)
ne2olow3,ne2oupp3,ne2omed3,nespeed3=histWRanges(3,'ne2o',dataLim)
mg2olow3,mg2oupp3,mg2omed3,mgspeed3=histWRanges(3,'o7',dataLim)
si2olow3,si2oupp3,si2omed3,sispeed3=histWRanges(3,'si2o',dataLim)
s2olow3,s2oupp3,s2omed3,sspeed3=histWRanges(3,'s2o',dataLim)
fe2olow3,fe2oupp3,fe2omed3,fespeed3=histWRanges(3,'fe2o',dataLim)
o76low3,o76upp3,o76med3,o76speed3=histWRanges(3,'o7',dataLim)

he2olow0, he2oupp0, he2omed0,hespeed0 = histWRanges(0,'he2o',dataLim)
c2olow0,c2oupp0,c2omed0,cspeed0=histWRanges(0,'c2o',dataLim)
n2olow0,n2oupp0,n2omed0,nspeed0=histWRanges(0,'n2o',dataLim)
ne2olow0,ne2oupp0,ne2omed0,nespeed0=histWRanges(0,'ne2o',dataLim)
mg2olow0,mg2oupp0,mg2omed0,mgspeed0=histWRanges(0,'o7',dataLim)
si2olow0,si2oupp0,si2omed0,sispeed0=histWRanges(0,'si2o',dataLim)
s2olow0,s2oupp0,s2omed0,sspeed0=histWRanges(0,'s2o',dataLim)
fe2olow0,fe2oupp0,fe2omed0,fespeed0=histWRanges(0,'fe2o',dataLim)
o76low0,o76upp0,o76med0,o76speed0=histWRanges(0,'o7',dataLim)

#Plots abundance ratios and variances.

#############********************##############

names = ['he2o','c2o','n2o','ne2o','o7','si2o','s2o','fe2o']
ylblparams = [[1,3.1,101],[-1,2,101],[-1.5,1,101],[-1.5,1,101],[-2,1,101],[-.55,0.5,101],
              [-1.5,0.5,100], [-2,1,101]]
reglbls = ['IS+CH','CME','CH','IS']
flagNum = [0,1,2,3]
ymaxparams = [1100,10,2.1,1.5,5,3.0,1.0,3.0]
yminparams = [180,1.0,0.25,0.2,0.1,0.3,0.1,0.3]
for nm in range(len( names)):
    ...
    for rel in reglbls:
        ...
        px,py = meanOfLog(5,x,y,speed = jvel)
        print py
...
ax4.set_ylim(ymin=0.2,ymax=2.5)
...
axo72mg.set_ylabel(r'${\bf {O^{\bf 7+}/Mg}}$ Abundance Ratio',fontweight = 'bold')
axo72mg.set_ylim(.2,2.3)
